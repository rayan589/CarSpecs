...
my_url = 'https://www.caranddriver.com/mercedes-benz/a-class/specs/2021/mercedes-benz_a-class_mercedes-benz-a-class_2021/413209'
...
CO2 = ct[23].text
Range = ct[24].text
FuelConsumption = ct[25].text
FuelCapacity = ct[27].text
Length = ct[30].text
Width = ct[31].text
Height = ct[32].text
NumSeats = ct[37].text
BrakeType = ct[59].text
FrontTireSize = ct[66].text
RearTireSize = ct[69].text
